    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center rounded-md border border-zinc-800 hover:bg-zinc-800"
                ),
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-zinc-800 hover:text-zinc-50 rounded-md transition-colors"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-blue-600 text-zinc-50 hover:bg-blue-500 hover:text-zinc-50 focus:bg-blue-600 focus:text-zinc-50 rounded-md",
